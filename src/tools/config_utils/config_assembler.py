...
def build_config(case_result: dict, mask_ctx: dict, sim_ctx: dict) -> tuple[dict, str]:
    ...
    dz["sponge_top"] = mask_ctx["pad_top"] - buffer
    dz["sponge_bot"] = mask_ctx["pad_bot"] - buffer
    dz["sponge_in"]  = mask_ctx["pad_left"] - buffer
    dz["sponge_out"] = mask_ctx["pad_right"] - buffer
    dz["buffer"]     = buffer
